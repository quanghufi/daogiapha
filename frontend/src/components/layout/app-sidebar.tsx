...
const mainNavItems = [
  ...
  { title: 'Quản lý quỹ', url: '/fund', icon: BookOpen },
...
const adminNavItems = [
  ...
  { title: 'Quản lý quỹ', url: '/admin/fund', icon: BookOpen },
      ...
      <SidebarHeader className="border-b border-sidebar-border/80 px-4 py-4">
        <Link href="/" className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            <span className="font-semibold text-sm">Đào tộc</span>
            <span className="text-xs text-muted-foreground">Ninh thôn</span>
          </div>
        </Link>
      </SidebarHeader>
